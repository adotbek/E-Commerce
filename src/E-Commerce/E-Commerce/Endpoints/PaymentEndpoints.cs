...
public static class PaymentEndpoints
{
    public static void MapPaymentEndpoints(this WebApplication app)
    {
        ...
        group.MapPost("/", async ([FromBody] PaymentCreateDto dto, IPaymentService service) =>
        {
        ...
        group.MapPut("/{id:long}", async (long id, [FromBody] PaymentUpdateDto dto, IPaymentService service) =>
        {
        ...
        group.MapDelete("/{id:long}", async (long id, IPaymentService service) =>
        {
        ...
        group.MapGet("/user/{userId:long}", async (long userId, IPaymentService service) =>
        {
        ...
        group.MapGet("/order/{orderId:long}", async (long orderId, IPaymentService service) =>
        {
        ...
        group.MapGet("/status/{status}", async (string status, IPaymentService service) =>
        {
        ...
        group.MapGet("/range", async ([FromQuery] DateTime startDate, [FromQuery] DateTime endDate, IPaymentService service) =>
        {
        ...
        group.MapGet("/user/{userId:long}/total", async (long userId, IPaymentService service) =>
        {
        ...
        group.MapGet("/total", async ([FromQuery] DateTime startDate, [FromQuery] DateTime endDate, IPaymentService service) =>
        {
        ...
        group.MapGet("/transaction/{transactionId}", async (string transactionId, IPaymentService service) =>
        {
        ...
        group.MapPut("/{paymentId:long}/status", async (long paymentId, [FromQuery] string newStatus, IPaymentService service) =>
        {
        ...
        group.MapGet("/order/{orderId:long}/completed", async (long orderId, IPaymentService service) =>
        {
