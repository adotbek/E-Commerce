...
public static class ProductEndpoints
{
    public static void MapProductEndpoints(this WebApplication app)
    {
        ...
        group.MapPost("/", async ([FromBody] ProductDto dto, [FromQuery] long categoryId, IProductService service) =>
        {
        ...
        group.MapPut("/{id:long}", async (long id, [FromBody] ProductDto dto, [FromQuery] long categoryId, IProductService service) =>
        {
        ...
        group.MapDelete("/{id:long}", async (long id, IProductService service) =>
        {
        ...
        group.MapGet("/featured", async (IProductService service) =>
        {
        ...
        group.MapGet("/search", async ([FromQuery] string keyword, IProductService service) =>
        {
        ...
        group.MapGet("/{id:long}/exists", async (long id, IProductService service) =>
        {
        ...
        group.MapPut("/{id:long}/update-stock", async (long id, [FromQuery] int quantity, IProductService service) =>
        {
        ...
        group.MapGet("/out-of-stock", async (IProductService service) =>
        {
        ...
        group.MapGet("/{id:long}/discount-price", async (long id, IProductService service) =>
        {
